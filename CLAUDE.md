...
worker/routes/admin.ts    /api/admin/*: login/logout/session, dish CRUD, ingredients vocab,
                          ...
                          analytics aggregates + /analytics/events (recent-activity feed)
