        ...
        {isDemo && (
          <div className="demo-banner">
            ...
            <div className="demo-banner__acts">
              ...
              {/* Same-origin links, like the footer's side pages, so Discord's
                  proxy serves them and the game still opens no new tabs. */}
              <a className="demo-banner__link" href="/admin?demo=1">
                See the back office
              </a>
