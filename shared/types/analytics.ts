// Every dashboard payload: the day's service, growth, players, countries,
// sources, the dish report, the funnel, the rhythm, the activity feed, the
// public stats, and the menu mix. Folded in the worker module beside each.

import type { Course, Temperature, Protein, Region, RoundKind, StartedByKind, Surface } from "./game";
import type { NightEntry } from "./night";
...
export interface DishReportRow {
  ...
  /** dist[i] = rounds solved in i+1 guesses. MAX_GUESSES wide. */
